...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title">编辑网站内容信息</h1>
		</div>
				...
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="article/updateArticle.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>主题</label> <select name="bannerid" class="form-control" id="bannerid"><c:forEach
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>是否置顶</label> <select class="form-control" name="istop" id="istop"><option value="是">是</option>
										<option value="否">否</option></select>
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>是否轮播</label> <select class="form-control" name="isflv" id="isflv"><option value="是">是</option>
										<option value="否">否</option></select>
								</div>
							</div>
							<div class="tab-pane active in" id="home">

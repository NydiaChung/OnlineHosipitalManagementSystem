...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title">编辑科室信息</h1>
		</div>
		<div class="main-content">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="dept/updateDept.action" name="myform" method="post" onsubmit="return check()" class="form">

							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>科室名称</label> <input type="text" name="deptname" class="form-control" id="deptname"
										value="${dept.deptname}" />
								</div>
							</div>
							<div>

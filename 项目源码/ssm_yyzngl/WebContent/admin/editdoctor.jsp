...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title">编辑医生信息</h1>
		</div>
		<div class="main-content">
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="doctor/updateDoctor.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									...
									<input class="form-control" type="text" name="image" value="${doctor.image}" id="image" onclick="selimage();"
										readonly="readonly" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>出生日期</label> <input type="text" name="birthday" class="form-control" id="birthday"
										value="${doctor.birthday}" onclick="WdatePicker()" readonly="readonly" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>学历</label> <input type="text" name="xueli" class="form-control" id="xueli" value="${doctor.xueli}" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>毕业院校</label> <input type="text" name="biye" class="form-control" id="biye" value="${doctor.biye}" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>最大接诊数</label> <input type="text" name="themax" class="form-control" id="themax" value="${doctor.themax}" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									...
									<textarea cols="80" name="contents" id="contents" rows="10">${doctor.contents} </textarea>
